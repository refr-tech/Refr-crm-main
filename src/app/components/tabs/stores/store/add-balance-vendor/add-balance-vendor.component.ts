...
@Component({
  selector: 'app-add-balance-vendor',
  templateUrl: './add-balance-vendor.component.html',
  styleUrls: ['./add-balance-vendor.component.scss']
})
export class AddBalanceVendorComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddBalanceVendorComponent>,
